...
| ACCT-019 | `/accounting/gl-account-enquiry`               | GL account enquiry           | **Done** | Prefix/ledger/description/branch/dept/currency/status/zero-balance tag; hybrid balances; View details → enquiry details |
