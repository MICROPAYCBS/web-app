...
export function buildSavingsAccountPayload(
  ...
  return stripEmpty({
    ...
    nominalAnnualInterestRate: input.nominalAnnualInterestRate,
    interestCompoundingPeriodType: input.interestCompoundingPeriodType,
    interestPostingPeriodType: input.interestPostingPeriodType,
    interestCalculationType: input.interestCalculationType,
    interestCalculationDaysInYearType: input.interestCalculationDaysInYearType,
    minRequiredOpeningBalance: input.minRequiredOpeningBalance,
    withdrawalFeeForTransfers: input.withdrawalFeeForTransfers,
    ...
    minOverdraftForInterestCalculation: input.minOverdraftForInterestCalculation,
    nominalAnnualInterestRateOverdraft: input.nominalAnnualInterestRateOverdraft,
    enforceMinRequiredBalance: input.enforceMinRequiredBalance,
    minRequiredBalance: input.minRequiredBalance,
