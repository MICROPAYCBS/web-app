...
import type { ShareProductCurrencyInput } from '@mifos/validation';
...
function currencySelectOptions(
  template: ShareProductStepProps['template']
...
export function CurrencyStep({
  ...
  onChange: (patch: Partial<ShareProductCurrencyInput>) => void;
}) {
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        Currency and rounding rules for share amounts on this product.
      </p>
