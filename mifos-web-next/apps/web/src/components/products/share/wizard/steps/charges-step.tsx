...
import type { ShareProductChargesInput } from '@mifos/validation';
...
function chargeOptions(template: ShareProductStepProps['template']): ChargeAmountLike[] {
...
export function ChargesStep({
  ...
  onChange: (patch: Partial<ShareProductChargesInput>) => void;
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <p className="text-sm text-muted-foreground">
        Select fees to attach to this share product.
        {currencyCode
