...
import type { DepositProductCurrencyInput } from '@mifos/validation';
...
function currencySelectOptions(
  template: DepositProductStepProps['template']
...
export function CurrencyStep({
  ...
  onChange: (patch: Partial<DepositProductCurrencyInput>) => void;
}) {
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        Currency and rounding rules for deposit amounts on this product.
      </p>
