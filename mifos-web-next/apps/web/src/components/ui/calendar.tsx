  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weeks: cn(
          "flex min-h-[calc(var(--cell-size)*6+2.5rem)] flex-col",
        ...
        dropdown: cn(
          "absolute inset-0 w-full cursor-default opacity-0",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "pointer-events-none flex h-8 items-center gap-1 rounded-(--cell-radius) pr-1 pl-2 text-sm [&>svg]:size-3.5 [&>svg]:text-muted-foreground",
          defaultClassNames.caption_label
        ),
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "flex-1 rounded-(--cell-radius) pb-1 text-[0.8rem] font-normal text-muted-foreground select-none",
