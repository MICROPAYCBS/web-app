...
export function LoanAccountAuditView({
  audits,
  loadFailed = false,
  totalRecords
}: {
  ...
  if (loadFailed) {
    return (
      <EmptyState
        ...
        description="Audit entries could not be loaded for this loan."
      />
    );
  }
  ...
  if (audits.length === 0) {
    return (
      <EmptyState
        ...
        description="No audit trail entries were found for this loan."
      />
    );
  }
